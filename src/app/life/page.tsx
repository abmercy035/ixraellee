    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <main className="mx-auto max-w-5xl px-5 py-12">
        <div className="border-b border-white/15 pb-8">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-blue-300">Category</p>
          <h1 className="mt-2 font-serif text-4xl font-black text-white sm:text-5xl">My Life</h1>
          <p className="mt-3 text-lg text-white/60">Personal essays, professional updates, and everyday observations.</p>
        </div>
