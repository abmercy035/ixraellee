  ...
  return (
    <div className="flex-1 p-8 space-y-8 bg-[#f8fafc]">
      <div className="border-b border-slate-200 pb-6">
        ...
        <h1 className="mt-2 font-serif text-3xl font-bold text-slate-950">Mail Broadcast Studio</h1>
        ...
        <form onSubmit={handleSend} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. New Story: Nation State and Public Memory"
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-6">
            ...
            <button
              type="submit"
              disabled={isSending}
              className="rounded-xl bg-[#0f172a] px-6 py-3 text-xs font-bold text-white transition hover:bg-slate-800 shadow-sm disabled:opacity-50"
            >
