    ...
    <div className="flex-1 p-8 space-y-8 bg-[#f8fafc]">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 pb-6">
        <div>
          ...
          <h1 className="mt-2 font-serif text-3xl font-bold text-slate-950">Newsletter Subscribers</h1>
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 rounded-xl bg-[#0f172a] px-5 py-2.5 text-xs font-bold text-white transition hover:bg-slate-800 shadow-sm"
          >
