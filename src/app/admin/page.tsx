    ...
    <div className="flex-1 p-8 space-y-8 bg-[#f8fafc]">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 pb-6">
        <div>
          ...
          <h1 className="mt-2 font-serif text-3xl font-bold text-slate-950">Ixraellee Journal Overview</h1>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-[#0f172a] px-5 py-2.5 text-xs font-bold text-white transition hover:bg-slate-800 shadow-sm cursor-pointer"
          >
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-4 font-serif text-4xl font-black text-slate-950">{stats?.totalPosts ?? posts.length}</p>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-4 font-serif text-4xl font-black text-slate-950">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-4 font-serif text-4xl font-black text-slate-950">{stats?.subscribers ?? "—"}</p>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-4 font-serif text-4xl font-black text-slate-950">{stats?.categories ?? "—"}</p>
              </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr]">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div>
                  <h2 className="font-serif text-xl font-bold text-slate-950">Recent Stories</h2>
                  ...
                  recentPosts.map((post) => (
                    <div key={post.slug} className="flex items-center justify-between py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-sm font-bold text-slate-950 line-clamp-1">{post.title}</h3>
            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
                <h2 className="font-serif text-xl font-bold text-slate-950">Quick Tools</h2>
